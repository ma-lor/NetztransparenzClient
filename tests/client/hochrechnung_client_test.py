...
2020-01-01;07:45;UTC;08:00;UTC;18,990;13,292;87,903;24,228"""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/hochrechnung/Solar/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
...
2020-01-01;00:00;UTC;00:15;UTC;99,070;53,000;25,600;9,778"""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/hochrechnung/Wind/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
...
2020-01-01;00:00;UTC;01:00;UTC;3573,990;1108,750;1165,210;130,408"""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/OnlineHochrechnung/Windonshore/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
...
2020-01-01;00:00;UTC;01:00;UTC;641,670;N.E.;526,230;N.E."""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/OnlineHochrechnung/Windoffshore/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
...
2020-01-01;08:00;UTC;09:00;UTC;727,210;514,160;1308,210;567,246"""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/OnlineHochrechnung/Solar/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
...
2022-12-01;07:45;UTC;08:00;UTC;47,090;96,000;300,940;152,000"""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/prognose/Solar/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
...
2022-12-01;00:00;UTC;00:15;UTC;5,442;5,000;5,000;2,000"""
    ...
    requests_mock.get(
        f"{_API_BASE_URL}/data/prognose/Wind/2020-01-01T00:00:00/2020-02-01T00:00:00",
        text=body,
    )
