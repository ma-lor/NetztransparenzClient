...
def test_traffic_light(client, requests_mock):
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/TrafficLight/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/NRVSaldo/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/NRVSaldo/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/RZSaldo/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/RZSaldo/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/PRL/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/PRL/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AktivierteSRL/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AktivierteSRL/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AktivierteMRL/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AktivierteMRL/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/SRLOptimierung/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/SRLOptimierung/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/MRLOptimierung/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/MRLOptimierung/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/MrlMolAbweichungen/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/SrlMolAbweichungen/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/Difference/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/Difference/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AbschaltbareLasten/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AbschaltbareLasten/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/Zusatzmassnahmen/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/Zusatzmassnahmen/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/Nothilfe/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
    result = client.nrvsaldo_nothilfe_betrieblich(START, END, True)
    assert result["50Hertz (Positiv)"].iloc[0] == 0
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/Nothilfe/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/reBAP/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AEPModule/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/AepSchaetzer/Betrieblich/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
    result = client.nrvsaldo_aep_schaetzer_betrieblich(START, END, True)
    assert result["AEP-Schätzer"].iloc[0] == 25.72

def test_nrvsaldo_finanzielle_wirkung_aep_module_qualitaetsgesichert(client, requests_mock):
    body="""Datum;Zeitzone;von;bis;Datenkategorie;Datentyp;Einheit;AEP Modul 1;AEP Modul 2;AEP Modul 3
10.10.2024;UTC;13:00;13:15;Finanzielle Wirkung AEP Module;Qualitätsgesichert;EUR;-2296,07;0,00;0,00
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/FinanzielleWirkungAEPModule/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
    result = client.nrvsaldo_finanzielle_wirkung_aep_module_qualitaetsgesichert(START, END, True)
...
"""
    requests_mock.get(f"{_API_BASE_URL}/data/NrvSaldo/VoAA/Qualitaetsgesichert/2024-01-01T00:00:00/2024-02-01T00:00:00", text=body)
