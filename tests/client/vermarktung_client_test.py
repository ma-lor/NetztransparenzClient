...
2020-01-01;22:00;UTC;22:15;UTC;N.A.;N.A.;-2,800;-13,000"""

    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/DifferenzEinspeiseprognose/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2020-01-01;22:00;UTC;22:15;UTC;-10110,672;60947,210;-49345,798;N.A."""

    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/InanspruchnahmeAusgleichsenergie/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2011-03-31;22:00;UTC;22:15;UTC;-156,000;0,000;165,000;90,000"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/UntertaegigeStrommengen/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
def test_vermarktung_epex(client, requests_mock):
    body="""Datum;von;Zeitzone von;bis;Zeitzone bis;50Hertz (MW);Amprion (MW);TenneT TSO (MW);TransnetBW (MW)
2020-01-01;00:00;UTC;00:15;UTC;0,000;0,000;-1,000;-1,200"""

    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/VermarktungEpex/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2011-12-31;23:00;UTC;23:15;UTC;N.A.;0,000;N.A.;0,000"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/VermarktungExaa/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2013-12-31;23:00;UTC;23:15;UTC;0,000;0,000;0,000;0,000"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/VermarktungsSolar/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2013-12-31;23:00;UTC;23:15;UTC;267,900;437,080;402,380;184,000"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/VermarktungsWind/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2013-12-31;23:00;UTC;23:15;UTC;N.A.;54,672;123,038;39,400"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/vermarktung/VermarktungsSonstige/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
31.12.2020;23:00;UTC;00:00;UTC;5,087"""

    requests_mock.get(f"{_API_BASE_URL}/data/Spotmarktpreise/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2024-01-01 01:00;Nein"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/NegativePreise/1/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2024-01-01 01:00;Nein"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/NegativePreise/3/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2024-01-01 01:00;Nein"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/NegativePreise/4/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
...
2024-01-01 01:00;Nein"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/NegativePreise/6/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
    result = client.negative_preise_6h(START, END, True)
    assert result["Negativ"].iloc[0] == "Ja"
    assert result["Datum"].iloc[0] == pd.Timestamp(2024, 1, 1, 0, 0)

def test_jahresmarktpraemie(client, requests_mock):
    body="""Alle Werte in ct/kWh;2020;2021;2022;2023;2024
...
"""
    ...
    assert result["2020"].iloc[0] == 3.047
...
2025-01-01;23:45;UTC;00:00;UTC;-7,940"""
    ...
    requests_mock.get(f"{_API_BASE_URL}/data/IdAep/2020-01-01T00:00:00/2020-02-01T00:00:00", text=body)
    result = client.id_aep(START,END, transform_dates=True)
    assert result["ID AEP in €/MWh"].iloc[0] == -7.94
    assert result["bis"].iloc[0] == pd.Timestamp(2025, 1, 2, 0, 0, tz="UTC") #check if day turnover works correctly