...
class VermarktungClient(BaseNtClient):
    ...
    def _basic_read_vermarktung(self, resource_url, earliest_data, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates = False, dateformat = _csv_date_format):
        """
        ...
        if(transform_dates):    
            df["von"] = pd.to_datetime(df["Datum"] + " " + df["von"] + " " + df["Zeitzone von"], format=dateformat, utc=True)
            df["bis"] = pd.to_datetime(df["Datum"] + " " + df["bis"] + " " + df["Zeitzone bis"], format=dateformat, utc=True)
    ...
    def _basic_read_negative_preise(self, resource_url, dt_begin: dt.datetime, dt_end: dt.datetime, transform_dates = False):
        """
    ...
    def vermarktung_differenz_einspeiseprognose(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/DifferenzEinspeiseprognose", "2011-03-31T22:00:00", dt_begin, dt_end, transform_dates)
    ...
    def vermarktung_inanspruchnahme_ausgleichsenergie(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/InanspruchnahmeAusgleichsenergie", "2011-03-31T22:00:00", dt_begin, dt_end, transform_dates)
    ...
    def vermarktung_untertaegige_strommengen(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/UntertaegigeStrommengen", "2011-03-31T22:00:00", dt_begin, dt_end, transform_dates)
    
    def vermarktung_epex(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        """
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/VermarktungEpex", "2011-12-31T22:00:00", dt_begin, dt_end, transform_dates)

    def vermarktung_exaa(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        """
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/VermarktungExaa", "2011-12-31T22:00:00", dt_begin, dt_end, transform_dates)

    def vermarktung_solar(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        """
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/VermarktungsSolar", "2013-12-31T23:00:00", dt_begin, dt_end, transform_dates)

    def vermarktung_wind(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        """
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/VermarktungsWind", "2013-12-31T23:00:00", dt_begin, dt_end, transform_dates)

    def vermarktung_sonstige(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        """
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/vermarktung/VermarktungsSonstige", "2013-12-31T23:00:00", dt_begin, dt_end, transform_dates) 
    
    def spotmarktpreise(self, dt_begin: dt.datetime | None = None, dt_end: dt.datetime | None = None, transform_dates=False):
        """
        ...
        If either dt_begin or dt_end is None, all available data will be queried.
            ...
            transform_dates -- The data contains times with date, time and timezone in separate columns
                               ...
                               columns "von" and "bis" that contain fully qualified timestamps. (default: False)
        """
        return self._basic_read_vermarktung("data/Spotmarktpreise", "2013-12-31T23:00:00", dt_begin, dt_end, transform_dates=transform_dates, dateformat="%d.%m.%Y %H:%M %Z")

    def negative_preise_1h(self, dt_begin: dt.datetime, dt_end: dt.datetime, transform_dates=False):
        """
        ...
        dt_begin and dt_end should not be too far apart since the api may throw an error for spans more than a year.
            ...
            transform_dates -- The data contains times as a string in the format "%Y-%m-%d %H:%M"
                               ...
                               fully qualified timestamp. (default: False)
        """
        return self._basic_read_negative_preise("data/NegativePreise/1", dt_begin, dt_end, transform_dates)

    def negative_preise_3h(self, dt_begin: dt.datetime, dt_end: dt.datetime, transform_dates=False):
        """
        Return a pandas Dataframe with data of the endpoint /NegativePreise/1.
        dt_begin and dt_end should not be too far apart since the api may throw an error for spans more than a year.
            ...
            transform_dates -- The data contains times as a string in the format "%Y-%m-%d %H:%M"
                               ...
                               fully qualified timestamp. (default: False)
        """
        return self._basic_read_negative_preise("data/NegativePreise/3", dt_begin, dt_end, transform_dates)

    def negative_preise_4h(self, dt_begin: dt.datetime, dt_end: dt.datetime, transform_dates=False):
        """
        Return a pandas Dataframe with data of the endpoint /NegativePreise/1.
        dt_begin and dt_end should not be too far apart since the api may throw an error for spans more than a year.
            ...
            transform_dates -- The data contains times as a string in the format "%Y-%m-%d %H:%M"
                               ...
                               fully qualified timestamp. (default: False)
        """
        return self._basic_read_negative_preise("data/NegativePreise/4", dt_begin, dt_end, transform_dates)
    
    def negative_preise_6h(self, dt_begin: dt.datetime, dt_end: dt.datetime, transform_dates=False):
        """
        Return a pandas Dataframe with data of the endpoint /NegativePreise/1.
        dt_begin and dt_end should not be too far apart since the api may throw an error for spans more than a year.
            ...
            transform_dates -- The data contains times as a string in the format "%Y-%m-%d %H:%M"
                               ...
                               fully qualified timestamp. (default: False)
        """
        return self._basic_read_negative_preise("data/NegativePreise/6", dt_begin, dt_end, transform_dates)
    ...
    def id_aep(self, dt_begin: dt.datetime, dt_end: dt.datetime, transform_dates=False):
        ...
        df.rename(columns={"Zeitzone": "Zeitzone von", "Zeitzone.1": "Zeitzone bis"}, inplace=True)

        if(transform_dates):
            df["von"] = pd.to_datetime(df["Datum von"] + " " + df["(Uhrzeit) von"] + " " + df["Zeitzone von"], format=_csv_date_format, utc=True)
            df["bis"] = pd.to_datetime(df["Datum von"] + " " + df["(Uhrzeit) bis"] + " " + df["Zeitzone bis"], format=_csv_date_format, utc=True)
            #The end of timeframes may be 00:00 of the next day which is not correctly represented in timestamps
            df["bis"] = df["bis"].where(df["bis"].dt.time != dt.time(0,0), df["bis"] + dt.timedelta(days=1))
            df = df.drop(["Datum von", "Zeitzone von", "Zeitzone bis"], axis=1).set_index("von")
